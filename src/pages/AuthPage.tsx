  ...
  return (
    <div className="min-h-screen bg-[#F8F6F1] flex flex-col items-center justify-center px-8 py-12">
      <div className="flex items-center gap-3 mb-6">
        <OwlMascot size={48} />
        <h1 className="text-[28px] font-[800] text-[#3B6B4A]">큐릭</h1>
      </div>

      <div className="w-full max-w-[440px] bg-white border border-[#E5E0D8] rounded-[20px] shadow-lg p-6">
        ...
        {error && (
          <div className="mb-3 p-3 bg-red-50 border border-red-200 rounded-xl text-[13px] text-red-600">
            {error}
          </div>
        )}
        ...
        {activeTab === "signup" ? (
          <form onSubmit={handleSignup}>
            ...
            <button
              ...
              className="w-full h-11 bg-[#3B6B4A] text-white rounded-xl text-[15px] font-[600] hover:bg-[#2d5438] transition-colors disabled:bg-[#C0C0C0] disabled:cursor-not-allowed"
            >
              {loading ? "처리 중..." : "가입하기"}
            </button>
      ...
      <p className="text-[12px] text-[#777777] mt-4 text-center">
...
function AuthInputField({
  ...
  return (
    <div className="mb-4">
      <label className="block text-[13px] font-[600] text-[#2C2C2C] mb-1.5">{label}</label>
      <div className="relative">
        <input
          ...
          className="w-full h-11 px-4 bg-white border border-[#E5E0D8] rounded-xl text-[14px] text-[#2C2C2C] placeholder:text-[#AAAAAA] outline-none focus:border-[#3B6B4A] focus:ring-2 focus:ring-[#E8F0EA] transition-all"
        />
        {isPassword && (
          <button
            type="button"
      ...
      {helperText && <p className="text-[11px] text-[#777777] mt-1">{helperText}</p>}
    </div>
  );
}
    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <button
          ...
          className="w-full h-11 px-4 bg-white border border-[#E5E0D8] rounded-xl text-[14px] text-left outline-none focus:border-[#3B6B4A] focus:ring-2 focus:ring-[#E8F0EA] transition-all flex items-center justify-between"
        >
...
function SocialLoginButtons({ mode, onSocial }: { mode: "signup" | "login"; onSocial: (provider: "kakao" | "google" | "naver") => void }) {
  ...
  return (
    <div className="space-y-2">
      <button type="button" onClick={() => onSocial("kakao")} className="w-full h-11 bg-[#FEE500] text-[#000000] rounded-xl text-[15px] font-[600] hover:bg-[#fdd800] transition-colors flex items-center justify-center gap-2">
      ...
      <button type="button" onClick={() => onSocial("naver")} className="w-full h-11 bg-[#03C75A] text-white rounded-xl text-[15px] font-[600] hover:bg-[#02b350] transition-colors flex items-center justify-center gap-2">
      ...
      <button type="button" onClick={() => onSocial("google")} className="w-full h-11 bg-white border border-[#E5E0D8] text-[#2C2C2C] rounded-xl text-[15px] font-[600] hover:bg-[#F8F6F1] transition-colors flex items-center justify-center gap-2">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
